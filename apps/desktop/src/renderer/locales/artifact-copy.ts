...
const ARTIFACT_COPY = {
  zh: {
    pane: {
      ...
      opening: '打开中…', openInFinder: '在 Finder 中打开', saving: '另存中…', saveAs: '另存为', copying: '复制中…', copy: '复制', deleting: '删除中…',
  ...
  en: {
    pane: {
      ...
      opening: 'Opening…', openInFinder: 'Show in Finder', saving: 'Saving…', saveAs: 'Save as', copying: 'Copying…', copy: 'Copy', deleting: 'Deleting…',
